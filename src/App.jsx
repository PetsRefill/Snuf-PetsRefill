...
const WHATSAPP_NUMBER = "31600000000"; // ← jouw zakelijk nummer
  ...
  return (
    <div style={{ background:"#f8f4ee", border:`1px solid ${GL}`, borderRadius:12, padding:"12px 14px", marginLeft:35, width:"calc(100% - 35px)", marginTop:8 }}>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
        ...
        <input style={inp} placeholder="WhatsApp-nummer" value={phone} onChange={e=>setPhone(e.target.value)} type="tel"/>
...
function Bubble({ msg, isNew, calcData, showSave, products, messages }) {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:isBot?"flex-start":"flex-end", marginBottom:9, animation:isNew?"fu .3s ease forwards":"none" }}>
      ...
      {isBot&&showSave&&calcData&&<SaveForm snufData={calcData} messages={messages}/>}
    </div>
  );
}
